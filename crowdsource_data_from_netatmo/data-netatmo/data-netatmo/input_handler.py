def get_user_inputs():
    ...
    Returns:
        tuple: A tuple containing user inputs for lat_ne, lon_ne, lat_sw, lon_sw, start_date_stamp, 
               start_time_stamp, end_date_stamp, end_time_stamp, csv_file, client_id, client_secret, 
               and refresh_token.
    """
    # Accept user inputs for various parameters
